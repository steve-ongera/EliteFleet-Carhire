...
def register(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            # Send welcome email (no activation required)
            mail_subject = 'Welcome to Our Website!'
            message = render_to_string('accounts/account_welcome_email.html', {
                'user': user,
            })
            to_email = email
            ...
            messages.success(request, 'Your account has been created and activated successfully! You can now log in.')
